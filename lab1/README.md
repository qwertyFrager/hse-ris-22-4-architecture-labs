...
5. **Инженер/разработчик (эксплуатация)**  
...
### FR-6. Просмотр результатов (дашборд/таблица)
...
### FR-8. Управление правилами (минимально)
...
## Перечень нефункциональных требований (3–5 наиболее значимых)
